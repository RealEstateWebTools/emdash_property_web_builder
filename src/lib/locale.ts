...
const UI_TRANSLATIONS: Record<string, Record<string, string>> = {
  es: {
    ...
    'Your details are handled with care and never passed to third parties.': 'Tus datos se tratan con cuidado y nunca se comparten con terceros.',
    'We can help with viewings, valuations, rentals, and buyer questions.': 'Podemos ayudarte con visitas, valoraciones, alquileres y consultas de compradores.',
    'About the office': 'Sobre la oficina',
    'Contact the office directly': 'Contactar la oficina directamente',
    'Name *': 'Nombre *',
  ...
  fr: {
    ...
    'Your details are handled with care and never passed to third parties.': 'Vos coordonnees sont traitees avec soin et ne sont jamais transmises a des tiers.',
    'We can help with viewings, valuations, rentals, and buyer questions.': 'Nous pouvons vous aider pour les visites, estimations, locations et questions acheteurs.',
    'About the office': 'A propos de l agence',
    'Contact the office directly': 'Contacter l agence directement',
    'Name *': 'Nom *',
    'Email *': 'Email *',
